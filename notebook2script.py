...
def getSortedFiles(allFiles, upTo=None):
    '''Returns all the notebook files sorted by name.
    ...
    upTo = None : no upper limit
         ...
         The sorting option is important to ensure that the notebook is executed in correct order.
    '''
    import glob
    ret = []
...
def notebook2script(fname=None, allFiles=None, upTo=None):
    ...
    '''
    # initial checks
    if (allFiles is None) and (upTo is not None): allFiles=True
